           ...
           <p>Are You Sure</p>
            <div className='flex gap-3'>
              <button onClick={() => {
                toast.dismiss(t.id)
                handleDelete(id)
              }} className='bg-red-600 text-white p-2 font-semibold rounded-md'>Delete</button>
              <button onClick={() => toast.dismiss(t.id)} className='bg-green-600 text-white p-2 font-semibold rounded-md'>Dismiss</button>
            </div>
        </div>
      )
    );
                    ...
                    services.map(service =>  <tr key={service._id}>
                      ...
                      <td className='px-4 py-4 text-sm whitespace-nowrap'>
                        <div className='flex items-center gap-x-6'>
                          <button className='text-gray-500 transition-colors duration-200   hover:text-red-500 focus:outline-none' onClick={() => modernDelete(service._id)}>
                            <svg
